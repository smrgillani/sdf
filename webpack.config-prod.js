    ...
    "rules": [
      ...
      },
      {
        "exclude": [
          ...
          path.join(process.cwd(), "node_modules/quill-emoji/dist/quill-emoji.css"),
  ...
  "plugins": [
    ...
    new ConcatPlugin({
      ...
      "filesToConcat": [
        ...
        path.join(process.cwd(), "node_modules/web-audio-recorder-js/lib-minified/WebAudioRecorder.min.js"),
      ]
    }),
    ...
    new webpack.NormalModuleReplacementPlugin(/environments\/environment\.ts/, 'environment.prod.ts'),
    new AotPlugin({
      "mainPath": "main.ts",
      "replaceExport": false,
