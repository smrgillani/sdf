...
export class FounderProjectCrowdEquityFunding implements OnInit{
    ...
    ngOnInit(){
        ...
        this.min_amount_equity= new FormControl({value:'', disabled: this.showReadOnly}, [Validators.required, CustomValidators.numeric]);
        ...
        this.frmFundDetails = this.fb.group({
            ...
            min_amount_equity: this.min_amount_equity,
